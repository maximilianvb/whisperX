...
def cli():
    ...
    parser.add_argument("--compound_words", type=str, default="", help="Add words separated by space that you want to not be compounded.")
    ...
    model = load_model(model_name, device=device, compound_words=compound_words, device_index=device_index, download_root=model_dir, compute_type=compute_type, language=args['language'], asr_options=asr_options, vad_options={"vad_onset": vad_onset, "vad_offset": vad_offset}, task=task, threads=faster_whisper_threads)
